...
// CODE HERE
const postTaxPrices = prices.map(element=>1.07*element) // = prices.map(/* Provide Your Callback Here );
...
// CODE HERE
const totalPopulation = populations.reduce((acc,curr) => acc + curr) //  = populations.reduce(/* Provide Your Callback Here */)
...
// CODE HERE
const myStrongest = monstersInYourPocket.filter(obj => obj.CP > 200)// = monstersInYourPocket.filter(/* Provide Your Callback Here */)
// const myStrongest = monstersInYourPocket.filter((obj) => {
//   return obj.CP > 200
// })
...
// const sum = bobsPurchases.reduce((acc,obj)=>acc+obj.price,0)
//console.log(sum)


const sum = purchases.filter(obj => obj.owner === "Bob").reduce((acc,obj)=>acc+obj.price,0)
console.log(sum)